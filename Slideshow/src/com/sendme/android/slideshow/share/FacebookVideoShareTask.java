 ...
 */
public class FacebookVideoShareTask
extends AsyncTask<Void, Float, Void>
{
	...
	public FacebookVideoShareTask(Facebook fbApp, String filePath)
	{
	...
	protected Void doInBackground(Void... params)
	{
		...
		HttpPost httppost = new HttpPost("https://graph.facebook.com/me/videos");
		...
		ContentBody cbFile = new FileBody(file, "video/mpeg");
		ContentBody filename = null;
		ContentBody cbAccessToken = null;
		try {
			filename = new StringBody(videoPath);
	...
	protected void onPostExecute(Void result) {
		...
		if (listener!= null) {
			if (retValue) {
			Log.d("Test listener", "Task - Upload video success"); // IT IS NOT NULL
