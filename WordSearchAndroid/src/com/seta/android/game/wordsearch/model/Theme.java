...
public enum Theme {
        ORIGINAL(R.drawable.theme_xmas_bg, Color.parseColor("black"), Color.parseColor("#33cc33"), Color.parseColor("#00cc00"), Color.parseColor("#ff0000"), Color.parseColor("#f0ff00")),    
        NIGHTSKY(R.drawable.theme_blackboard_bg, Color.parseColor("black"), Color.parseColor("#33cc33"), Color.parseColor("#00cc00"), Color.parseColor("#ff0000"), Color.parseColor("#f0ff00")),
        SKY(R.drawable.theme_bluesky_bg, Color.parseColor("white"), Color.parseColor("green"), Color.parseColor("yellow"), Color.parseColor("red"), Color.parseColor("blue")),
        PINK(R.drawable.theme_parchment_bg, Color.parseColor("black"), Color.parseColor("#05a9a7"), Color.parseColor("#00d0ce"), Color.parseColor("#0000ff"), Color.parseColor("#00ff00")),
        SEAGREEN(R.drawable.theme_writingpaper_bg, Color.parseColor("yellow"), Color.parseColor("#ffba00"), Color.parseColor("red"), Color.parseColor("#ff00fc"), Color.parseColor("#ffc000"));
